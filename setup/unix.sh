...
haxelib git linc_luajit https://github.com/MRK2009/linc_luajit-0.6.3 --quiet
...
haxelib git hxCodec https://github.com/MRK2009/hxCodec-0.6.3 --quiet
haxelib git hxcpp https://github.com/th2l-devs/hxcpp --quiet
haxelib git lime https://github.com/MRK2009/lime --quiet
